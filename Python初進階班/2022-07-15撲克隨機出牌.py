...
while len(list3) < 5 :
    ...
    if item not in list3 :
        list3.append(item)
        if item[1] == 'H'  :
            之寧模組.畫紅心(t1, screen1, -450 + 225 * n, 0, 1, item[0])
        elif item[1] == 'D' :
            之寧模組.畫方塊(t1, screen1, -450 + 225 * n, 0, 1, item[0])
        elif item[1] == 'S' :
            之寧模組.畫黑桃(t1, screen1, -450 + 225 * n, 0, 1, item[0])
        else :
            之寧模組.畫梅花(t1, screen1, -450 + 225 * n, 0, 1, item[0])
        n = n + 1
