...
def check(func):
    ...
    arg_keys = tuple(parameters.keys())   # 拿到参数名称
    # print(arg_keys)           # ('a', 'b', 'c')
    @functools.wraps(func)      # foobar(100,'abc',55.5)
...
@check
def foobar1(*,a: int=1, b: str='abc', c: float=3.2) -> tuple:
    return a, b, c

print(foobar1(10,b='py',c=2.5))
